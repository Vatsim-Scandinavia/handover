        ...
        <div class="container">
            <div class="row justify-content-center" style="padding-top: 10%">
                <div class="col-md-6 text-center">
                    ...
                    <a href="{{ env('APP_URL') }}"><img src="{{asset('img/logos/vat'.mb_strtolower(Config::get('app.owner_short')).'.svg')}}" alt="{{env('APP_OWNER_CONTACT')}} logo" class="w-100 pb-4" style="max-width: 300px"/></a>
