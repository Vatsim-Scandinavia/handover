    ...
    public function handle()
    {
        ...
        foreach ($users as $user) {
            ...
            if (collect($response)->isNotEmpty()) {
                ...
                $user->first_name = ucfirst($this->controller->Windows1252ToUTF8($response->data->personal->name_first));
                $user->last_name = ucfirst($this->controller->Windows1252ToUTF8($response->data->personal->name_last));
